...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    <td><button type="button" class="text-success" id=${index}><i class="fa fa-check-square-o"></i>Accept</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><i class="fa fa-trash"></i>Reject</button></td>
                </tr>`;
    });
